...
<html>
	<head>
        ...
        <link href="{{ asset('leohub/assets/css/main.css') }}" rel="stylesheet" />
	</head>
	<body>
		...
		<!-- Scripts -->
            <script src="{{ asset('leohub/assets/js/jquery.min.js') }}"></script>
            <script src="{{ asset('leohub/assets/js/jquery.scrolly.min.js') }}"></script>
            <script src="{{ asset('leohub/assets/js/skel.min.js') }}"></script>
            <script src="{{ asset('leohub/assets/js/util.js') }}"></script>
            <script src="{{ asset('leohub/assets/js/main.js') }}"></script>
